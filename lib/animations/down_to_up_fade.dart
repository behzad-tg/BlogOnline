...
class DowToUpFade extends StatefulWidget {
  final double delay;
  final Widget child;
  const DowToUpFade({Key? key, required this.child, required this.delay}) : super(key: key);

  @override
  _DowToUpFadeState createState() => _DowToUpFadeState();
}

class _DowToUpFadeState extends State<DowToUpFade>
